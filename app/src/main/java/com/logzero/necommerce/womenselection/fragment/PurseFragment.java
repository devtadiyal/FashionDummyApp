...
public class PurseFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_purse, container,
                false);
    ...
    private ArrayList<ShoesModel> prepareData() {
        ...
        for (int i = 0; i < Data.purse_image.length; i++) {
            ShoesModel androidVersion = new ShoesModel();
            androidVersion.setName(Data.purse_name[i]);
            androidVersion.setImage(Data.purse_image[i]);
            androidVersion.setSubtitle(Data.purse_subtitle[i]);
            androidVersion.setPrice(Data.purse_price[i]);
