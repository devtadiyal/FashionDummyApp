...
public class WatchFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_watch, container,
                false);
    ...
    private ArrayList<ShoesModel> prepareData() {
        ...
        for (int i = 0; i < Data.watch_image.length; i++) {
            ShoesModel androidVersion = new ShoesModel();
            androidVersion.setName(Data.watch_name[i]);
            androidVersion.setImage(Data.watch_image[i]);
            androidVersion.setSubtitle(Data.watch_subtitle[i]);
            androidVersion.setPrice(Data.watch_price[i]);
